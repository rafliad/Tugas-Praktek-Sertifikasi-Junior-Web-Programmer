...
<head>
    ...
    <!--[if !mso]>-->
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700&amp;family=Open+Sans:wght@400&amp;family=Inter+Tight:wght@400;700&amp;display=swap" rel="stylesheet" type="text/css" />
    <!--<![endif]-->
    <!--[if mso]>
<xml>
...
<body id="body" class="t105" style="min-width:100%;Margin:0px;padding:0px;background-color:#FFFFFF;">
                        ...
                        <tr>
                            <td align="center">
                                <table class="t101" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                    <tr>
                                        <td width="687" class="t100" style="width:687px;">
                                            <table class="t99" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                                <tr>
                                                    <td class="t98" style="border:1px solid #EBEBEB;overflow:hidden;background-color:#FFFFFF;padding:44px 42px 32px 42px;border-radius:3px 3px 3px 3px;">
                                                                        ...
                                                                        <tr>
                                                                            <td width="42" class="t3" style="width:42px;">
                                                                                <table class="t2" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                                                                    <tr>
                                                                                        <td class="t1">
                                                                                            <div style="font-size:0px;"><img class="t0" style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;" width="42" height="46.50277264325324" alt="" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/SMAN_5_Bandung.png/1082px-SMAN_5_Bandung.png" /></div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="t96" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                                            <td width="601" class="t95" style="width:620px;">
                                                                                <table class="t94" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                                                                    <tr>
                                                                                        <td class="t93" style="background-color:#FFFFFF;padding:20px 0 20px 0;">
                                                                                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;">
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table class="t92" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                            <tr>
                                                                                                                <td width="600" class="t91" style="width:600px;">
                                                                                                                    <table class="t90" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                                                                                                        <tr>
                                                                                                                            <td class="t89" style="border:1px solid #757575;">
                                                                                                                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;">
                                                                                                                                    <tr>
                                                                                                                                        <td align="center">
                                                                                                                                            <table class="t40" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                <tr>
                                                                                                                                                    <td width="598" class="t39" style="width:800px;">
                                                                                                                                                        <table class="t38" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                                                                                                                                            <tr>
                                                                                                                                                                <td class="t37">
                                                                                                                                                                    <div class="t36" style="width:100%;text-align:left;">
                                                                                                                                                                        <div class="t35" style="display:inline-block;">
                                                                                                                                                                            <table class="t34" role="presentation" cellpadding="0" cellspacing="0" align="left" valign="top">
                                                                                                                                                                                <tr class="t33">
                                                                                                                                                                                    <td></td>
                                                                                                                                                                                    <td class="t24" width="199.33333" valign="top">
                                                                                                                                                                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="t23" style="width:100%;">
                                                                                                                                                                                            <tr>
                                                                                                                                                                                                <td class="t22" style="border-bottom:1px solid #757575;padding:8px 12px 8px 12px;">
                                                                                                                                                                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;">
                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                            <td align="center">
                                                                                                                                                                                                                <table class="t21" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                                        <td width="175.33333333333334" class="t20" style="width:600px;">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <td class="t32" width="398.66667" valign="top">
                                                                                                                                                                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="t31" style="width:100%;">
                                                                                                                                                                                            <tr>
                                                                                                                                                                                                <td class="t30" style="border-left:1px solid #757575;border-bottom:1px solid #757575;padding:8px 12px 8px 12px;">
                                                                                                                                                                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;">
                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                            <td align="center">
                                                                                                                                                                                                                <table class="t29" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                                        <td width="373.6666666666667" class="t28" style="width:600px;">
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td align="center">
                                                                                                                                            <table class="t64" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                <tr>
                                                                                                                                                    <td width="598" class="t63" style="width:800px;">
                                                                                                                                                        <table class="t62" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                                                                                                                                            <tr>
                                                                                                                                                                <td class="t61">
                                                                                                                                                                    <div class="t60" style="width:100%;text-align:left;">
                                                                                                                                                                        <div class="t59" style="display:inline-block;">
                                                                                                                                                                            <table class="t58" role="presentation" cellpadding="0" cellspacing="0" align="left" valign="top">
                                                                                                                                                                                <tr class="t57">
                                                                                                                                                                                    <td></td>
                                                                                                                                                                                    <td class="t48" width="199.33333" valign="top">
                                                                                                                                                                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="t47" style="width:100%;">
                                                                                                                                                                                            <tr>
                                                                                                                                                                                                <td class="t46" style="border-bottom:1px solid #757575;padding:8px 12px 8px 12px;">
                                                                                                                                                                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;">
                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                            <td align="center">
                                                                                                                                                                                                                <table class="t45" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                                        <td width="175.33333333333334" class="t44" style="width:600px;">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <td class="t56" width="398.66667" valign="top">
                                                                                                                                                                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="t55" style="width:100%;">
                                                                                                                                                                                            <tr>
                                                                                                                                                                                                <td class="t54" style="border-left:1px solid #757575;border-bottom:1px solid #757575;padding:8px 12px 8px 12px;">
                                                                                                                                                                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;">
                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                            <td align="center">
                                                                                                                                                                                                                <table class="t53" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                                        <td width="373.6666666666667" class="t52" style="width:600px;">
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td align="center">
                                                                                                                                            <table class="t88" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                <tr>
                                                                                                                                                    <td width="598" class="t87" style="width:800px;">
                                                                                                                                                        <table class="t86" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                                                                                                                                            <tr>
                                                                                                                                                                <td class="t85">
                                                                                                                                                                    <div class="t84" style="width:100%;text-align:left;">
                                                                                                                                                                        <div class="t83" style="display:inline-block;">
                                                                                                                                                                            <table class="t82" role="presentation" cellpadding="0" cellspacing="0" align="left" valign="top">
                                                                                                                                                                                <tr class="t81">
                                                                                                                                                                                    <td></td>
                                                                                                                                                                                    <td class="t72" width="199.33333" valign="top">
                                                                                                                                                                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="t71" style="width:100%;">
                                                                                                                                                                                            <tr>
                                                                                                                                                                                                <td class="t70" style="padding:8px 12px 8px 12px;">
                                                                                                                                                                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;">
                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                            <td align="center">
                                                                                                                                                                                                                <table class="t69" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                                        <td width="175.33333333333334" class="t68" style="width:600px;">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <td class="t80" width="398.66667" valign="top">
                                                                                                                                                                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="t79" style="width:100%;">
                                                                                                                                                                                            <tr>
                                                                                                                                                                                                <td class="t78" style="border-left:1px solid #757575;padding:8px 12px 8px 12px;">
                                                                                                                                                                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;">
                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                            <td align="center">
                                                                                                                                                                                                                <table class="t77" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;">
                                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                                        <td width="373.6666666666667" class="t76" style="width:600px;">
